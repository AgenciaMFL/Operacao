...
| `assets/img/climate-cta-mockup-mobile.webp` | Mesma banda, telas ≤720px (`.climate-cta__mockup`) — export exato do Figma node 2981:36 "Mobile" (enviado pelo usuário), 800x713, fundo sólido #106b61 idêntico a `--color-teal-dark` (emenda com o card invisível, sem crop/máscara) e bordas retas; exibida como imagem flutuante após o texto, no mesmo padrão de `.nr1-panel__mockup` (texto em fluxo normal no topo, mockup menor abaixo, sem esticar a imagem para cobrir o card inteiro) |
