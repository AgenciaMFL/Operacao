...
| `assets/img/trust-band-bg.webp` | Fundo da seção 06 "Sigilo e LGPD" — mãos segurando um tablet com um escudo, enviada diretamente pelo usuário (versão com faixa vazia maior no topo, para caber título+lede+cards por cima sem sobrepor o tablet); exibida na resolução nativa, sem crop/stretch |
