...
| `assets/img/trust-band-bg-mobile-v2.webp` | Mesma seção, telas ≤720px (`<picture>` source) — segunda versão enviada pelo usuário (800x1031, mãos+tablet+escudo, faixa vazia no topo ~70% da altura), substitui `trust-band-bg.webp` só nesse tier; mesmo tratamento de recorte (`object-fit:cover object-position:bottom`) que já existia para 721-1024px, só re-calibrado para a proporção própria dessa imagem |
